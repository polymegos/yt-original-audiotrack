...
(function() {
    ...
    function redirectToDesktop() {
        // Only redirect if we're on mobile AND the setting is enabled, default to true
        const redirectEnabled = GM_getValue(DESKTOP_REDIRECT_ENABLED, true);
        ...
        if (isMobile && redirectEnabled && !hasDesktopParam) {
    ...
    function createToggleSwitch() {
        ...
        waitForElement('#masthead-container').then(container => {
            ...
            if (searchBox) {
                ...
                // Fallback: insert at the end of the masthead container
